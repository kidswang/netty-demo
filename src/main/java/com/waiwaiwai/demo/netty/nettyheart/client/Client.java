package com.waiwaiwai.demo.netty.nettyheart.client;

import com.waiwaiwai.demo.netty.nettyheart.common.CustomHeartbeatHandler;
    ...
    protected void doConnect() {
        ...
        future.addListener((ChannelFutureListener) channelFutureListener -> {
            if (channelFutureListener.isSuccess()) {
                channel = channelFutureListener.channel();
                System.out.println("Connect to server successfully!");
            } else {
                // 10 秒后重试
                channelFutureListener.channel().eventLoop().schedule(this::doConnect, 10, TimeUnit.SECONDS);
            }
        });
